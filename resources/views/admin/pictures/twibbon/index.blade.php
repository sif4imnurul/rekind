        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-[var(--button)] rounded-[16px] shadow overflow-hidden flex flex-col transition hover:shadow-lg">
                ...
                <div class="relative w-full aspect-[1/1] bg-gray-100">
                    <img src="{{ asset('img/pict-4.jpg') }}" alt="Twibbon" class="w-full h-full object-cover" />
                    
                    <!-- Action Buttons di atas gambar -->
                    <div class="absolute top-2 right-2 flex flex-col gap-2">
                        <a href="#" class="w-[34px] h-[34px] bg-sky-300 rounded-full shadow flex items-center justify-center">
                        ...
                        <a href="#" class="w-[34px] h-[34px] bg-yellow-300 rounded-full shadow flex items-center justify-center">
                        ...
                        <a href="#" class="w-[34px] h-[34px] bg-red-300 rounded-full shadow flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="black">
                ...
                <div class="p-3 text-center">
                    <h3 class="text-md font-semibold text-[var(--judul)] truncate">Nama Twibbon</h3>
                </div>
            </div>
