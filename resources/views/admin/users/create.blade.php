...
<div class="w-full overflow-x-hidden">
    <div class="w-full h-full relative bg-white flex flex-col py-4 px-4 gap-3 rounded-md">
        <h2 class="text-2xl font-semibold text-[var(--judul)] mb-4">Create New User</h2>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="w-full md:w-1/2 px-2 mb-4">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div class="w-full md:w-1/2 px-2 mb-4">
                    ...
                    <input type="text" name="unit" id="unit" value="{{ old('unit') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <!-- NPK -->
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <label for="npk" class="block text-[var(--judul)] text-sm font-bold mb-1">NPK</label>
                    <input type="text" name="npk" id="npk" value="{{ old('npk') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <!-- Divisi -->
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <label for="divisi" class="block text-[var(--judul)] text-sm font-bold mb-1">Divisi</label>
                    <input type="text" name="divisi" id="divisi" value="{{ old('divisi') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <!-- Telepon -->
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <label for="telepon" class="block text-[var(--judul)] text-sm font-bold mb-1">Telepon</label>
                    <input type="tel" name="telepon" id="telepon" value="{{ old('telepon') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <!-- Tanggal Lahir -->
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <label for="tanggal_lahir" class="block text-[var(--judul)] text-sm font-bold mb-1">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <!-- Alamat -->
                <div class="w-full px-2 mb-4">
                    <label for="alamat" class="block text-[var(--judul)] text-sm font-bold mb-1">Alamat</label>
                    <textarea name="alamat" id="alamat" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat') }}</textarea>
                </div>
                ...
                <div class="w-full md:w-1/2 px-2 mb-4">
                    ...
                    <select name="role" id="role" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="userb" {{ old('role') == 'userb' ? 'selected' : '' }}>User Biasa</option>
                        <option value="userk" {{ old('role') == 'userk' ? 'selected' : '' }}>User Khusus</option>
                ...
                <!-- Profile Picture -->
                <div class="w-full md:w-1/2 px-2 mb-4">
                    <label for="image" class="block text-[var(--judul)] text-sm font-bold mb-1">Profile Picture</label>
