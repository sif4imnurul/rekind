...
<div class="w-full overflow-x-hidden">
    ...
    <div class="w-full h-full relative bg-white flex flex-col py-4 px-4 gap-3 rounded-md">
        ...
        <div class="w-full flex flex-col md:flex-row justify-between items-center gap-3">
            <!-- Search Box -->
            <form action="{{ route('admin.buku.search') }}" method="GET" class="w-full md:w-[60%]">
        ...
        <div class="w-full overflow-x-auto">
            <table class="min-w-full text-left text-sm text-gray-700">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-4 py-3">{{ ($books->currentPage() - 1) * $books->perPage() + $index + 1 }}</td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex flex-row">
                                ...
                                <form action="{{ route('admin.buku.delete', $book->id_produk) }}" method="POST" class="delete-form inline-block">
                                    @csrf
                                    @method('DELETE')
