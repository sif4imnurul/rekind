...
@section('title', 'Detail Annual Report')
        ...
        <div class="flex flex-wrap gap-0">
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">{{ $annualReport->nama }}</p>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">{{ $annualReport->tahun }}</p>
                </div>
            </div>
            ...
            <div class="w-full p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">{{ $annualReport->deskripsi }}</p>
                </div>
            </div>
                ...
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-4">
                    ...
                    <div class="relative w-full aspect-[3/4] border border-gray-300 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                        <div class="text-center px-4">
                            <img src="{{ asset('/files/' . $annualReport->foto) }}" alt="Cover Image" class="w-full h-full object-cover">
                        </div>
                    </div>
