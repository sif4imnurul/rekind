        ...
        <div class="flex flex-wrap gap-0">
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">Laporan Keuangan Tahunan</p>
                </div>
            </div>
            ...
            <div class="w-full p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">Laporan tahunan mencakup seluruh aktivitas keuangan selama periode Januari–Desember.</p>
                </div>
            </div>
