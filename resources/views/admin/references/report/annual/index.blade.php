...
<div class="w-full overflow-x-hidden">
    ...
    <div class="w-full h-full relative bg-white flex flex-col py-4 px-4 gap-3 rounded-md">
        ...
        <div class="w-full flex flex-col md:flex-row justify-between items-center gap-3">
            <!-- Search Box -->
            <form action="{{ route('admin.annual.search') }}" method="GET" class="w-full md:w-[60%]">
            ...
            <!-- Button Tambah -->
            <a href="{{ route('admin.annual.create') }}" class="h-[40px] px-6 rounded-lg bg-[var(--button)] hover:bg-[var(--sub-judul)] text-white text-sm font-medium flex items-center justify-center">
                Tambah
            </a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex flex-row">
                                <a href="{{ route('admin.annual.show', ['id' => $report->id_produk]) }}" class="bg-sky-300 p-2 rounded-l-lg border">
                                ...
                                <a href="{{ route('admin.annual.edit', ['id' => $report->id_produk]) }}" class="bg-yellow-300 p-2 border border-l-0 border-r-0">
                                ...
                                <form action="{{ route('admin.annual.delete', ['id' => $report->id_produk]) }}" method="POST" class="delete-form inline-block">
                                    @csrf
                                    @method('DELETE')
