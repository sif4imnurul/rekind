...
<div class="w-full overflow-x-hidden">
    <form action="{{ route('admin.agenda.store') }}" method="POST" class="w-full">
        @csrf
                        ...
                        <div class="relative w-full">
                            <div class="bg-[var(--highlight-text-box)] px-4 py-1 rounded-t-md">
                                <textarea name="catatan" 
                                          rows="4"
                                          class="w-full bg-transparent text-[var(--judul)] text-base tracking-wide font-normal focus:outline-none resize-none">{{ old('catatan') }}</textarea>
                            </div>
                            <hr class="border-[1px] text-[var(--judul)]">
                        </div>
                        @error('catatan')
