            ...
            <table class="min-w-full text-left text-sm text-gray-700">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-4 py-3">judul project</td> <!--atau negative-->
                        <td class="px-4 py-3">Divisi pertama</td>
                        <td class="px-4 py-3">tinggi</td>
                        <td class="px-4 py-3 underline">
                            <a href="#">12 desember, 2024</a>
                        </td>
                        <td class="px-4 py-3 underline">
                            <a href="#">12 desember, 2024</a>
                        </td>
                        <td class="px-4 py-3">
                            <div class="flex flex-row">
                                ...
                                <a href="#" class="bg-yellow-300 p-2 border">
