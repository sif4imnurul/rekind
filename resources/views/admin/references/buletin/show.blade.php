        ...
        <div class="flex flex-wrap gap-0">
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    ...
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">Contoh judul Buletin</p>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-gray-300 flex flex-col gap-3">
                    <label class="text-[var(--judul)] text-lg font-bold leading-[22px]">Tanggal Publikasi</label>
                    <p class="text-[var(--sub-text)] text-base tracking-wide font-medium">2023-12-12</p>
                </div>
            </div>
