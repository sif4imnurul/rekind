            ...
            <table class="min-w-full text-left text-sm text-gray-700">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-4 py-3">positive</td> <!--atau negative-->
                        <td class="px-4 py-3">Kesimpulan isi berita</td>
                        <td class="px-4 py-3 underline">
                            <a href="#">sumber berita</a>
                        </td>
                        <td class="px-4 py-3">
                            <div class="flex flex-row">
                                ...
                                <a href="#" class="bg-yellow-300 p-2 rounded-l-lg border">
