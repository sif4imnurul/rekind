  ...
  <div :class="open ? 'block' : 'hidden'" class="absolute top-full left-0 w-full bg-[var(--6)] px-6 md:static md:flex md:items-center md:gap-20 md:p-0 md:w-auto">
    ...
    <div x-data="{ dropdownOpen: false }" class="w-full md:relative">
      ...
      >
        ...
        <a href="{{ route('buletin.grid') }}" class="block px-4 py-2 text-sm text-[var(--sub-text)] hover:bg-[var(--highlight-text-box)] hover:text-[var(--judul)]">Buletin</a>
    ...
    <div x-data="{ dropdownOpen: false }" class="w-full md:relative">
      ...
      >
        ...
        <a href="{{ route('flyer-ucapan.index') }}" class="block px-4 py-2 text-sm text-[var(--sub-text)] hover:bg-[var(--highlight-text-box)] hover:text-[var(--judul)]">Flyer Ucapan</a>
      </div>
    </div>
    ...
    <div class="flex space-x-4">
      <a href="{{ route('login') }}" class="px-4 py-2 text-sm font-medium text-[var(--sub-text)] hover:text-[var(--button)]">Login</a>
      <a href="{{ route('register') }}" class="px-4 py-2 text-sm font-medium text-[var(--sub-text)] hover:text-[var(--button)]">Register</a>
    </div>
    @endauth
  </div>
</nav>