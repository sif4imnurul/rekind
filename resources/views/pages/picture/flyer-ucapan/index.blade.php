...
<div class="w-full px-4 md:px-25 py-6 overflow-x-hidden flex flex-col gap-6">
    <div class="max-w-full flex justify-between items-start">
        ...
        <div class="w-[662px] overflow-hidden flex flex-col justify-start items-start gap-[10px]">
            <div class="text-[var(--judul)] text-[24px] font-bold leading-[32px] tracking-[0.10px] font-montserrat">Flyer Ucapan</div>
            <div class="text-[var(--sub-text)] text-[14px] font-normal leading-[20px] tracking-[0.20px] font-montserrat">Kumpulan Flyer ucapan pada hari-hari atau event penting.</div>
        </div>
    </div>
    ...
    <div class="w-full px-4 py-6">
        <div class="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            @for ($i = 0; $i < 12; $i++)
                <div class="relative w-full border border-[#7BB7D1] rounded-lg overflow-hidden">
                    <img src="{{ asset('img/buku-5.jpg') }}" alt="Foto" class="w-full h-[330px] object-cover" />

                    <!-- Icon Download -->
                    <a href="{{ asset('img/buku-5.jpg') }}" download class="absolute bottom-2 right-2 rounded-lg p-1 border border-[var(--button)] shadow-md text-[var(--button)] hover:text-white hover:bg-[var(--button)] transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path d="M12 16l4-5h-3V4h-2v7H8z" />
                            <path d="M20 18H4v-7H2v7a2 2 0 002 2h16a2 2 0 002-2v-7h-2v7z" />
                        </svg>
                    </a>
                </div>
            @endfor
