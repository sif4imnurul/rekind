    ...
    <div class="w-full px-4 py-6">
        <div class="max-w-[1600px] mx-auto flex flex-wrap justify-center gap-6">
            ...
            <div class="w-[327px] p-4 bg-white overflow-hidden rounded-[20px] outline-1 outline-[#7BB7D1] outline-offset-[-1px] flex flex-col gap-[13px]">
                <img src="{{ asset('img/book-1.jpg') }}" alt="Buletin" class="w-full h-[416px] rounded-[16px] border border-[#7BB7D1]" />
                <div class="flex justify-between items-center">
                    <div class="text-[#1D3A6D] text-[18px] font-bold leading-[22px] font-montserrat">Judul Buletin</div>
...
<div class="w-full px-4 md:px-25 py-6 overflow-x-hidden">
    ...
    <div class="w-full px-4 py-6">
        <div id="bulletins-container" class="max-w-[1600px] mx-auto flex flex-wrap justify-center gap-6">
            @foreach($bulletins as $buletin)
            <!-- Card -->
            <div class="w-[327px] p-4 bg-white overflow-hidden rounded-[20px] outline-1 outline-[#7BB7D1] outline-offset-[-1px] flex flex-col gap-[13px]">
                <img src="{{ asset('files/' . $buletin->foto) }}" alt="{{ $buletin->nama }}" class="w-full h-[416px] rounded-[16px] border border-[#7BB7D1] object-cover" />
                <div class="flex justify-between items-center">
                    <div class="text-[#1D3A6D] text-[18px] font-bold leading-[22px] font-montserrat">{{ $buletin->nama }}</div>
                    <div class="w-[33px] h-[33px] relative">
                ...
                <div class="h-[16px] flex items-start gap-2">
                    <div class="text-[#BDBDBD] text-[13px] font-normal leading-[16px] font-montserrat truncate">{{ Str::limit($buletin->deskripsi, 100) }}</div>
                </div>
            </div>
            @endforeach
        </div>
