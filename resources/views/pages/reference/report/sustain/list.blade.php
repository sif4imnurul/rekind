...
@section('title', 'Sustainability Report | Rekind')
...
<div class="w-full px-4 md:px-25 py-6 overflow-x-hidden">
    ...
    <div class="w-full h-full flex flex-col md:flex-row items-center justify-between gap-y-4 md:gap-[30px]">
        ...
        <div class="w-full max-w-[510px] h-[62px] flex items-center gap-[10px]">
            <form action="{{ route('sustain.list') }}" method="GET" class="w-full">
    ...
    <div class="flex flex-wrap gap-0">
        ...
        <div class="w-full md:w-1/2 p-4">
            <a href="{{ route('sustain.list') }}">
                <div class="w-full h-full px-3 py-2 inline-flex justify-center items-center border bg-[var(--button)] rounded-full border-[var(--button)] gap-2">
