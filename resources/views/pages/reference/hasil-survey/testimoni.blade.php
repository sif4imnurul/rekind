...
<div class="w-full px-4 md:px-25 py-6 overflow-x-hidden">
    ...
    <div class="w-full inline-flex justify-center items-center gap-2.5 mt-4">
    ...
    <div class="w-full h-full rounded-[10px] inline-flex flex-col justify-center items-center gap-4">
        <!-- Testimoni Box 1 -->
