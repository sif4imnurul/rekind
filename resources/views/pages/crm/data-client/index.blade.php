    ...
    <div class="py-6 flex flex-col gap-6">
        ...
        <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-[#7BB7D1] flex flex-col items-center gap-4">
            ...
            <div class="w-full flex justify-center">
                <h2 class="text-[#1D3A6D] text-2xl font-bold leading-[22px] text-center">Data Client 1</h2>
            </div>
            ...
            <div class="w-full flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                ...
                <div class="flex-1 relative">
                    <div class="bg-[#D6E4F5] rounded-t px-4 py-2 h-12 flex items-center">
                        <div class="text-[#1D3A6D] text-base tracking-wide">xxx</div>
                    </div>
        ...
        <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-[#7BB7D1] flex flex-col items-center gap-4">
            <!-- Title -->
            <div class="w-full flex justify-center">
                <h2 class="text-[#1D3A6D] text-2xl font-bold leading-[22px] text-center">Data Client 2</h2>
            </div>
        ...
        <div class="w-full p-6 bg-white rounded-[20px] outline-1 outline-[#7BB7D1] flex flex-col items-center gap-4">
            <!-- Title -->
            <div class="w-full flex justify-center">
                <h2 class="text-[#1D3A6D] text-2xl font-bold leading-[22px] text-center">Data Client 3</h2>
            </div>
