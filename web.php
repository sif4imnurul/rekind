...
Route::prefix('admin')->name('admin.')->middleware(IsAdmin::class)->group(function () {
    ...
    // Routes for Hasil Survey Brand static pages
    Route::get('hasil-survey-brand', [HasilSurveyBrandController::class, 'index'])->name('hasil-survey-brand.index');
    Route::get('hasil-survey-brand/awareness', [HasilSurveyBrandController::class, 'brandAwareness'])->name('hasil-survey-brand.awareness');
    Route::get('hasil-survey-brand/positioning', [HasilSurveyBrandController::class, 'brandPositioning'])->name('hasil-survey-brand.positioning');
    Route::get('hasil-survey-brand/cse', [HasilSurveyBrandController::class, 'cse'])->name('hasil-survey-brand.cse');
    Route::get('hasil-survey-brand/skl', [HasilSurveyBrandController::class, 'skl'])->name('hasil-survey-brand.skl');

    // Resource route for Survey Documents (PDFs)
    Route::resource('survey-documents', SurveyDocumentController::class)->parameters(['survey-documents' => 'id']);
});